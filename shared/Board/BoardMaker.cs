...
namespace BoggleShared
{
    public class BoardMaker
    {
        ...
        public void LoadRandomBoard(int sideLength)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(sideLength), Consts.c_argExceptionDescSideLength);
            }
        ...
        public void LoadGivenBoard(char[] board, int sideLength)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(board), Consts.c_argExceptionDescBoard);
            }
